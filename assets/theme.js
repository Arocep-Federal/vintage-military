/*
Motion 5.3.0 by Archetype Themes (https://archetypethemes.co)
  ...
  ***************** VINTAGE MILITARY 1.0 ****************
  ***************** VINTAGE MILITARY 1.0 ****************

  THEME UPDATED by FRANKFORT CREATIVE for AROCEP FEDERAL
...
if (console && console.log) {
  console.log('Vintage Military theme ('+theme.settings.themeVersion+') by Frankfort Creative');
}
